...
use crate::cityjson::core::attributes::Attributes as CoreAttributes;
use crate::cityjson::core::metadata::BBox as CoreBBox;
...
pub struct CityObjectCore<SS: StringStorage, RR: ResourceRef, CoType> {
    ...
    attributes: Option<CoreAttributes<SS, RR>>,
    geographical_extent: Option<CoreBBox>,
    children: Option<Vec<RR>>,
    parents: Option<Vec<RR>>,
    extra: Option<CoreAttributes<SS, RR>>,
}
...
impl<SS: StringStorage, RR: ResourceRef, CoType> CityObjectCore<SS, RR, CoType> {
    ...
    pub fn attributes(&self) -> Option<&CoreAttributes<SS, RR>> {
        self.attributes.as_ref()
    }

    pub fn attributes_mut(&mut self) -> &mut CoreAttributes<SS, RR> {
        self.attributes.get_or_insert_with(CoreAttributes::new)
    }

    pub fn geographical_extent(&self) -> Option<&CoreBBox> {
        self.geographical_extent.as_ref()
    }

    pub fn set_geographical_extent(&mut self, bbox: Option<CoreBBox>) {
        self.geographical_extent = bbox;
    }
    ...
    pub fn extra(&self) -> Option<&CoreAttributes<SS, RR>> {
        self.extra.as_ref()
    }

    pub fn extra_mut(&mut self) -> &mut CoreAttributes<SS, RR> {
        self.extra.get_or_insert_with(CoreAttributes::new)
    }
}
