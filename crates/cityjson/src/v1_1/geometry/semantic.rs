...
mod tests {
    ...
    // Note: test_semantic_creation, test_semantic_attributes, test_semantic_children,
    // and test_semantic_parent are now generated by the impl_semantic_trait! macro
    // and are available in the semantic_trait_macro_tests module
