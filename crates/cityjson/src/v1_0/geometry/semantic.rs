...
mod tests {
    ...
    fn test_semantic_display() {
        ...
        // Add attributes directly using inline storage
    ...
    fn test_semantic_equality() {
        ...
        // Add inline attributes for both semantics to make them equal
        semantic10
            .attributes_mut()
        ...
        // Use the same attributes for both semantics to make them equal
