...
fn build_metadata_patterns(model: &mut OwnedModel) -> Result<()> {
...
fn set_cityobject_id_1_attributes(co_1: &mut OwnedCityObject) {
...
fn add_cityobject_id_1_geometry(
    ...
    // a mutable borrow to the CityModel.
    {
        ...
        let patio_door_semantic = Semantic::new(SemanticType::Extension("+PatioDoor".to_string()));
...
fn build_cityobject_id_3(co_3: &mut OwnedCityObject) {
    co_3.attributes_mut()
...
fn build_metadata_with_reference(model: &mut OwnedModel) -> Result<()> {
...
fn build_metadata_with_return() -> Result<OwnedMetadata> {
