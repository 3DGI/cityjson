...
`cityjson-arrow` and `cityjson-parquet` define the ADR 3 transport boundary for
`cityjson-rs`.
...
- `cityjson-arrow` owns the live Arrow stream transport and conversion surface.
...
The package format is currently `cityjson-arrow.package.v3alpha1`.
