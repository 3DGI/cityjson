...
use cityjson_types::resources::CityObjectHandle;
use cityjson_types::resources::handles::{MaterialHandle, TextureHandle};
use cityjson_types::resources::storage::{
    BorrowedStringStorage, OwnedStringStorage, StringStorage,
};
...
) -> Result<cityjson_types::resources::GeometryHandle>
where
    SS: FixtureStorage<'a>,
{
