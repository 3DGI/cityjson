...
- `cityjson_types::relational::RelationalAccess` exposes both
...
- `cityjson_types::query::summary()` provides cheap scalar counts over the same contract
...
- trim or retire older raw/handle-heavy interop entry points once downstream crates adopt `cityjson_types::relational`
