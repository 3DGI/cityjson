...
`cityjson-types` implements the [CityJSON 2.0](https://www.cityjson.org/specs/2.0.1/) data model in Rust.
...
```rust
use cityjson_types::v2_0::*;     // all CityJSON v2.0 types
use cityjson_types::prelude::*;  // handles, storage strategies, error types
```
...
```rust
use cityjson_types::v2_0::{CityJSONVersion, CityModel, CityModelType};
